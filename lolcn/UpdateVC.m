...
-(void) loadPosts{
    NSURL *url = [NSURL URLWithString:@"http://www.dota2.com/news/updates/"];
    ...
    [request setCompletionBlock:^{
        ...
        NSArray *titles = [xmlDoc elementsMatchingPath:@"//body/center/div/div/div/div[3]/div[@id='recentPostsSearchArea']/div/a"];
        NSArray *times = [xmlDoc elementsMatchingPath:@"//body/center/div/div/div/div[3]/div[@id='recentPostsSearchArea']/div/div[@class='recent_entry_date']"];
    ...
    [MBProgressHUD showHUDAddedTo:self.view animated:YES label:NSLocalizedString(@"Loading...",nil) details:NSLocalizedString(@"updating updates",nil)];
    _reloading = YES;
